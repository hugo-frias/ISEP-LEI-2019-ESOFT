...
8. O sistema regista a tarefa e informa o colaborador de organização do sucesso da operação.
...
|  		 |	... conhece a organização do colaborador?	| Plataforma| IE: No Modelo de Dominio, A Plataforma tem registadas/contém Organização |
...
| 4. O sistema mostra a lista de categorias de tarefa e pede para selecionar uma		 |		... tem conhecimento sobre as categorias de tarefa existentes?  |   Plataforma | Information Expert (IE) - A Plataforma contém/agrega CategoriaTarefa     |
|  		 |
...
|| ...valida os dados de Tarefa(validação global)?| Organização| IE: A Organização contém Tarefas ||
| 7.  O administrativo confirma.  		 | |   | |
| 8. O sistema regista a tarefa e informa o colaborador de organização do sucesso da operação. |  ...guarda a Tarefa especificada/criada?| Organização | IE. No Modelo de Dominio a Organização contém Tarefas|
