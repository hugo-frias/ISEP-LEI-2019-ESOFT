...
| 10.  O sistema regista os dados e cria o anúncio e informa o colaborador da organização do sucesso da operação, ** ficando em processo de agendamento para a publicação automática da tarefa.** |...guarda o Anuncio?| RegistoAnuncios|IE|
| |...informa o colaborador?|PublicarTarefaUI|
| |  **.. cria instância de seriacao automatica?**|**Tarefa**|**Creator(Regra1)**
