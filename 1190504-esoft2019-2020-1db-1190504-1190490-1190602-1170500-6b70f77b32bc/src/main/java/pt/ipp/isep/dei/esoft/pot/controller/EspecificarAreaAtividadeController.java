...
public class EspecificarAreaAtividadeController
{
    ...
    public boolean novaAreaAtividade(String strCodigo, String strDescricaoBreve, String strDescricaoDetalhada)
    {
        try
        {
            this.m_oAreaAtividade = this.m_oPlataforma.getRegistoAreasAtividade().novaAA(strCodigo, strDescricaoBreve,strDescricaoDetalhada);
            return this.m_oPlataforma.getRegistoAreasAtividade().validaAA(this.m_oAreaAtividade);
        }
    ...
    {
        return this.m_oPlataforma.getRegistoAreasAtividade().registaAA(this.m_oAreaAtividade);
    }
